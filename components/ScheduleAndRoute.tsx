      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg text-slate-500">
            Perjalanan malam yang nyaman. Tidur nyenyak di jalan, bangun segar di tujuan.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 bg-white p-8 md:p-10 rounded-[2.5rem] shadow-apple relative overflow-hidden">
             ...
             <h3 className="text-2xl font-bold text-brand-dark mb-8 relative z-10">Timeline Perjalanan</h3>
             ...
             <div className="relative pl-4 z-10">
                ...
                <div className="relative flex gap-6 pb-12 group">
                  ...
                  <div>
                    <span className="inline-block px-3 py-1 rounded-full bg-brand-orange/10 text-brand-orange text-xs font-bold mb-2">16.00 - 17.00 WIB</span>
                    <h4 className="text-lg font-bold text-brand-dark">Penjemputan</h4>
                    <p className="text-slate-500 text-sm mt-1">Tim kami menjemput Anda di depan rumah (Area Purworejo & Sekitarnya).</p>
                  </div>
                </div>
                ...
                <div className="relative flex gap-6 pb-12 group">
                  ...
                  <div>
                    <span className="inline-block px-3 py-1 rounded-full bg-slate-100 text-slate-600 text-xs font-bold mb-2">Perjalanan</span>
                    <h4 className="text-lg font-bold text-brand-dark">Menuju Jakarta</h4>
                    <p className="text-slate-500 text-sm mt-1">Via Tol Trans Jawa & Jalur Selatan. Istirahat 1x di Rest Area.</p>
                  </div>
                </div>
                ...
                <div className="relative flex gap-6 group">
                  ...
                  <div>
                    <span className="inline-block px-3 py-1 rounded-full bg-green-100 text-green-700 text-xs font-bold mb-2">04.00 WIB (Estimasi)</span>
                    <h4 className="text-lg font-bold text-brand-dark">Tiba di Tujuan</h4>
                    <p className="text-slate-500 text-sm mt-1">Pengantaran ke alamat tujuan di Jabodetabek.</p>
                  </div>
                </div>
             </div>
          </div>
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
               ...
               <div className="relative z-10">
                 ...
                 <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {PICKUP_POINTS.map((point, idx) => (
                      <div key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-colors cursor-default">
            ...
            <div className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-apple border border-slate-100 flex-grow">
               <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-brand-dark">Area Pengantaran</h3>
               </div>
               
               <div className="flex flex-wrap gap-3">
                  {DROPOFF_POINTS.map((point, idx) => (
                    <span key={idx} className="inline-flex items-center px-4 py-2 rounded-full bg-slate-50 border border-slate-100 text-slate-600 text-sm font-medium hover:border-blue-200 hover:text-blue-600 hover:bg-blue-50 transition-all cursor-default">
                      {point}
                    </span>
                  ))}
               </div>
